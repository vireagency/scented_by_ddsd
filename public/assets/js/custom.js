(function ($) {
  ...
  $(".single-product-nav-slider").slick({
    ...
    arrows: true,
    prevArrow:
      '<span class="slider-icon slider-icon-prev"><i class="icofont-simple-up"></i></span>',
    nextArrow:
      '<span class="slider-icon slider-icon-next"><i class="icofont-simple-down"></i></span>',
    dots: false,
    focusOnSelect: true,
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function searchProducts() {
    ...
    products.forEach(function(product) {
      var productName = product.querySelector(".title a").innerText.toLowerCase();
